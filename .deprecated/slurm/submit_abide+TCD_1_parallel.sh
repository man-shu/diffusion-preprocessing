...
#SBATCH --array=0-42%100

dirs=(/data/parietal/store3/work/haggarwa/diffusion/diffusion-preprocessing/data/abide/TCD_1/sub-*)
...
/home/input/abide/TCD_1 \
/home/input/abide/TCD_1/derivatives \
