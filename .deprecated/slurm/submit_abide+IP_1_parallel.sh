...
#SBATCH --array=0-56%100

dirs=(/data/parietal/store3/work/haggarwa/diffusion/diffusion-preprocessing/data/abide/IP_1/sub-*)
echo ${dirs[${SLURM_ARRAY_TASK_ID}]:90}
...
/home/input/abide/IP_1 \
/home/input/abide/IP_1/derivatives \
