...
output_dir = os.path.join(
    root, "result", f"tracto_synthetic_output_{timestamp}"
)
config_path = os.path.join(
    root, "diffusion-preprocessing", "config_synthetic.cfg"
)

# Create the diffusion preprocess wf
tracto = init_tracto_wf(
    output_dir=output_dir, config_file="config_synthetic.cfg"
)
