...
if __name__ == '__main__':
    ...
    PATH = '/storage/store2/work/zmohamed/mathfun/'
    ...
    pbx2.inputs.out_dir = '/storage/store2/work/zmohamed/mathfun/tractography_wf/_session_1_subject_id_' \
        + subject_list + '_visit_1/probtrackx2'
