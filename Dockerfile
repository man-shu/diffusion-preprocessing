...
RUN cd antsInstallExample && ./installANTs.sh
...
RUN tar -vzxpf freesurfer-linux-ubuntu22_amd64-7.4.1.tar.gz \
...
RUN python fslinstaller.py --no_self_update -n -d /fsl
